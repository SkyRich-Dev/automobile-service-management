    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden text-slate-900">
      ...
      >
        <div className="p-6 flex items-center gap-3">
          ...
          {isSidebarOpen && <span className="text-xl font-bold text-white tracking-tight whitespace-nowrap">AutoServ</span>}
        </div>
        ...
        <div className="p-4 border-t border-slate-800">
          <button
            onClick={onLogout}
            className="flex items-center gap-3 p-3 w-full rounded-lg hover:bg-rose-600/10 hover:text-rose-500 transition-colors group"
          >
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-40 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 text-sm text-slate-500 bg-slate-50 px-3 py-1.5 rounded-full border border-slate-200">
              ...
              <select className="bg-transparent border-none focus:ring-0 p-0 text-slate-600 font-medium">
          ...
          <div className="flex items-center gap-4">
            <div className="relative hidden lg:block">
              ...
              <input 
                type="text" 
                placeholder="Global Search (Vehicle, Job, Customer)..." 
                className="pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm w-80 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
              />
            </div>
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
              ...
              <div className="w-10 h-10 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center border-2 border-white shadow-sm font-bold">
                {user.name.charAt(0)}
              </div>
            </div>
          </div>
