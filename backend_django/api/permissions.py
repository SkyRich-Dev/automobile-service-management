...
class RoleBasedPermission(permissions.BasePermission):
    ...
    RESOURCE_PERMISSIONS = {
        ...
        'designations': {
            'list': 'all_authenticated',
            'retrieve': 'all_authenticated',
            'create': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.HR_MANAGER],
            'update': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.HR_MANAGER],
            'delete': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER],
        },
        'hsn-sac-codes': {
            'list': 'all_authenticated',
            'retrieve': 'all_authenticated',
            'create': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.ACCOUNTS_MANAGER,
                       UserRole.ACCOUNTANT],
            'update': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.ACCOUNTS_MANAGER,
                       UserRole.ACCOUNTANT],
            'delete': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER],
        },
        'invoices': {
        ...
        'contracts': {
            ...
            'check_eligibility': 'all_authenticated',
            'submit_for_approval': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER,
                                    UserRole.SERVICE_MANAGER, UserRole.SALES_MANAGER, UserRole.SERVICE_ADVISOR],
            'approve': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER,
                        UserRole.SERVICE_MANAGER, UserRole.REGIONAL_MANAGER],
            'reject': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER,
                       UserRole.SERVICE_MANAGER, UserRole.REGIONAL_MANAGER],
            'suspend': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER,
                        UserRole.SERVICE_MANAGER],
            'resume': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER,
                       UserRole.SERVICE_MANAGER],
            'terminate': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER],
            'consumptions': 'all_authenticated',
            'audit_log': 'all_authenticated',
            'add_vehicle': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER,
                           UserRole.SERVICE_MANAGER, UserRole.SERVICE_ADVISOR],
            'add_coverage_rule': [UserRole.SUPER_ADMIN, UserRole.CEO_OWNER, UserRole.BRANCH_MANAGER,
                                  UserRole.SERVICE_MANAGER, UserRole.SERVICE_ADVISOR],
        },
        'inventory-alerts': {
            'list': 'all_authenticated',
